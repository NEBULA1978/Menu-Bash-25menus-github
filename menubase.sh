...
while :; do
    ...
    echo ""
    echo "0. Abrir carpeta del menubase.sh para poder ejecutar menu sin estar en su ruta"
    ...
    echo "36. Ejecutar menus dentro de la carpeta VARIOS-MENUS-BASH-main 15 menus bash"
    ...
    0)
        echo "Abrir carpeta del menubase.sh para poder ejecutar menu sin estar en su ruta"
        cd /home/next/Música/Menu-Bash-25menus-github
        ./menubase.sh
        read foo
        ;;
...
"
    ...
    35)
        ...
        ls /home/next/Música/Menu-Bash-25menus-github/VARIOS-MENUS-BASH-main
        # bash ./menubase.sh
        # bash ./miscript-ver-carpetas.sh | more
        read foo
        ;;
    36)
        echo "Ejecutar menus dentro de la carpeta VARIOS-MENUS-BASH-main 15 menus bash"
        cd VARIOS-MENUS-BASH-main
        ./menubase.sh
